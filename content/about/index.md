...
This site is my attempt to reconnect with that world. The hope is that this site will grow to host format specifications of files, modding tools, old game modifications, tutorials and guides. The hope is also to present tools that hopefully are cross-platform and open source, so that anyone can use them.
...
Whether you're a veteran from the old days, someone who wishes to understand how the games and formats worked, or just someone with a soft spot for 1990s PC gaming, the hope is that you’ll find something interesting here.
